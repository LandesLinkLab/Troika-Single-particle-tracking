function positions = KKframe2particles( frames, varargin )
%KKframe2particles Applies the radial symmetry method to SNR boosted frames
...
for t = 1 : size(frames,3)
    ...
    positions(t).p = particle_identify(im,varargin{:});
    waitbar(t*invT,wb);
end
close(wb);